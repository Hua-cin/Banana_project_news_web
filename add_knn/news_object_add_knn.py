...
class News:
    ...
    def upload_to_db(self):
        ...
        try:
            ...
            sql_str = 'insert into Daniel_news_test (web_name, publish_time, web_class, title, url, related, web_tag, output_class, log_dt) ' \
                      'values(\'{}\', \'{}\', \'{}\', \'{}\', \'{}\',\'{}\', \'{}\', \'{}\', \'{}\');' \
                .format(self.web_name, self.publish_time, self.web_class, self.title, self.url, self.related, self.web_tag, self.output_class, now)
